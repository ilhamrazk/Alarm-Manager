package com.example.ilhamrazk.myalarmmanager;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    //Siapkan 2 id untuk 2 macam alarm, ontime dna repeating
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        showAlarmNotifiation(context, title, message, notifId);
    }
    ...
    private void showAlarmNotifiation(Context context, String title, String message, int notifId) {
